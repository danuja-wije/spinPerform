...
@app.callback([Output('profile-history', 'children'),Output('line-chart', 'figure')],[Input('profile', 'n_clicks'),Input("intermediate-value", "data"),Input('line-chart', 'relayoutData')])
